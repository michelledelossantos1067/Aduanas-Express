...
public class SolicitudTransporteServices : ISolicitudTransporteService{
    ...
    public async Task Crear(CreateSolicitudTransporteDTOs createSolicitudTransporteDTOs){
        var solicitudTrans = new SolicitudTransporte
        {
            ...
            VehiculoId = createSolicitudTransporteDTOs.VehiculoId,
            ConductorId = createSolicitudTransporteDTOs.ConductorId,
            UsuarioSolicitaId = createSolicitudTransporteDTOs.UsuarioSolicitaId,
        };
    ...
    public async Task Actualizar(int Id,UpdateSolicitudTransporteDTOs updateSolicitudTransporteDTOs){
        ...
        solicitudTrans.UsuarioSolicitaId = updateSolicitudTransporteDTOs.UsuarioSolicitaId;
